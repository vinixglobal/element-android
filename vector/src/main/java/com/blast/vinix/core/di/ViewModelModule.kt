...
import com.blast.vinix.core.platform.ConfigurationViewModel
import com.blast.vinix.features.call.SharedActiveCallViewModel
import com.blast.vinix.features.crypto.keysbackup.restore.KeysBackupRestoreFromKeyViewModel
import com.blast.vinix.features.crypto.keysbackup.restore.KeysBackupRestoreFromPassphraseViewModel
import com.blast.vinix.features.crypto.keysbackup.restore.KeysBackupRestoreSharedViewModel
import com.blast.vinix.features.crypto.keysbackup.setup.KeysBackupSetupSharedViewModel
import com.blast.vinix.features.discovery.DiscoverySharedViewModel
import com.blast.vinix.features.home.HomeSharedActionViewModel
import com.blast.vinix.features.home.room.detail.RoomDetailSharedActionViewModel
import com.blast.vinix.features.home.room.detail.timeline.action.MessageSharedActionViewModel
import com.blast.vinix.features.home.room.list.actions.RoomListQuickActionsSharedActionViewModel
import com.blast.vinix.features.reactions.EmojiChooserViewModel
import com.blast.vinix.features.roomdirectory.RoomDirectorySharedActionViewModel
import com.blast.vinix.features.roomprofile.RoomProfileSharedActionViewModel
import com.blast.vinix.features.roomprofile.alias.detail.RoomAliasBottomSheetSharedActionViewModel
import com.blast.vinix.features.roomprofile.settings.historyvisibility.RoomHistoryVisibilitySharedActionViewModel
import com.blast.vinix.features.roomprofile.settings.joinrule.RoomJoinRuleSharedActionViewModel
