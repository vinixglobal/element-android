...
package com.blast.vinix.features.home.room.detail
...
import com.blast.vinix.core.dialogs.ConfirmationDialogBuilder
import com.blast.vinix.core.dialogs.GalleryOrCameraDialogHelper
import com.blast.vinix.core.dialogs.withColoredButton
import com.blast.vinix.core.epoxy.LayoutManagerStateRestorer
...
import com.blast.vinix.core.extensions.showKeyboard
import com.blast.vinix.core.extensions.trackItemsVisibilityChange
import com.blast.vinix.core.glide.GlideApp
import com.blast.vinix.core.glide.GlideRequests
import com.blast.vinix.core.intent.getFilenameFromUri
import com.blast.vinix.core.intent.getMimeTypeFromUri
import com.blast.vinix.core.platform.VectorBaseFragment
import com.blast.vinix.core.resources.ColorProvider
import com.blast.vinix.core.ui.views.ActiveCallView
import com.blast.vinix.core.ui.views.ActiveCallViewHolder
import com.blast.vinix.core.ui.views.ActiveConferenceView
import com.blast.vinix.core.ui.views.JumpToReadMarkerView
import com.blast.vinix.core.ui.views.NotificationAreaView
import com.blast.vinix.core.utils.Debouncer
import com.blast.vinix.core.utils.KeyboardStateUtils
import com.blast.vinix.core.utils.PERMISSIONS_FOR_AUDIO_IP_CALL
import com.blast.vinix.core.utils.PERMISSIONS_FOR_VIDEO_IP_CALL
import com.blast.vinix.core.utils.PERMISSIONS_FOR_WRITING_FILES
import com.blast.vinix.core.utils.TextUtils
import com.blast.vinix.core.utils.checkPermissions
import com.blast.vinix.core.utils.colorizeMatchingText
import com.blast.vinix.core.utils.copyToClipboard
import com.blast.vinix.core.utils.createJSonViewerStyleProvider
import com.blast.vinix.core.utils.createUIHandler
import com.blast.vinix.core.utils.isValidUrl
import com.blast.vinix.core.utils.openUrlInExternalBrowser
import com.blast.vinix.core.utils.registerForPermissionsResult
import com.blast.vinix.core.utils.saveMedia
import com.blast.vinix.core.utils.shareMedia
import com.blast.vinix.core.utils.shareText
import com.blast.vinix.core.utils.toast
import com.blast.vinix.features.attachments.AttachmentTypeSelectorView
import com.blast.vinix.features.attachments.AttachmentsHelper
import com.blast.vinix.features.attachments.ContactAttachment
import com.blast.vinix.features.attachments.preview.AttachmentsPreviewActivity
import com.blast.vinix.features.attachments.preview.AttachmentsPreviewArgs
import com.blast.vinix.features.attachments.toGroupedContentAttachmentData
import com.blast.vinix.features.call.SharedActiveCallViewModel
import com.blast.vinix.features.call.VectorCallActivity
import com.blast.vinix.features.call.WebRtcPeerConnectionManager
import com.blast.vinix.features.call.conference.JitsiCallViewModel
import com.blast.vinix.features.command.Command
import com.blast.vinix.features.crypto.keysbackup.restore.KeysBackupRestoreActivity
import com.blast.vinix.features.crypto.util.toImageRes
...
import com.blast.vinix.features.home.room.detail.composer.TextComposerView
...
import com.blast.vinix.features.home.room.detail.timeline.action.EventSharedAction
import com.blast.vinix.features.home.room.detail.timeline.action.MessageActionsBottomSheet
import com.blast.vinix.features.home.room.detail.timeline.action.MessageSharedActionViewModel
...
import com.blast.vinix.features.home.room.detail.timeline.item.AbsMessageItem
import com.blast.vinix.features.home.room.detail.timeline.item.MessageFileItem
import com.blast.vinix.features.home.room.detail.timeline.item.MessageImageVideoItem
import com.blast.vinix.features.home.room.detail.timeline.item.MessageInformationData
import com.blast.vinix.features.home.room.detail.timeline.item.MessageTextItem
...
import com.blast.vinix.features.html.PillImageSpan
import com.blast.vinix.features.html.PillsPostProcessor
import com.blast.vinix.features.invite.VectorInviteView
import com.blast.vinix.features.media.ImageContentRenderer
import com.blast.vinix.features.media.VideoContentRenderer
...
import com.blast.vinix.features.share.SharedData
import com.blast.vinix.features.themes.ThemeUtils
import com.blast.vinix.features.widgets.WidgetActivity
import com.blast.vinix.features.widgets.WidgetArgs
import com.blast.vinix.features.widgets.WidgetKind
