...
import com.blast.vinix.core.animations.AppBarStateChangeListener
import com.blast.vinix.core.animations.MatrixItemAppBarStateChangeListener
...
import com.blast.vinix.core.extensions.copyOnLongClick
...
import com.blast.vinix.features.home.room.detail.RoomDetailPendingAction
...
import com.blast.vinix.features.roommemberprofile.powerlevel.EditPowerLevelDialogs
...
class RoomMemberProfileFragment @Inject constructor(
    ...
    private fun handleShareRoomMemberProfile(permalink: String) {
        ...
        val qrCode = view.findViewById<com.blast.vinix.core.ui.views.QrCodeImageView>(R.id.itemShareQrCodeImage)
